      ...
      <div>
        <div className="space-y-3">
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed text-[0.6rem]">El ganador será el resultado de las <span className="font-bold text-foreground">10PM de Súper Gana</span><br /><span className="font-bold text-foreground">un día después de agotarse las semillas</span></p>
          </div>
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed text-[0.6rem]">El ganador será el resultado de las <span className="font-bold text-foreground">4PM de Súper Gana</span><br /><span className="font-bold text-foreground">un día después de agotarse las semillas</span></p>
          </div>
          <div>
            ...
            <p className="text-xs text-muted-foreground leading-relaxed text-[0.6rem]">El ganador será el resultado de las <span className="font-bold text-foreground">1PM de Súper Gana</span><br /><span className="font-bold text-foreground">un día después de agotarse las semillas</span></p>
          </div>
        </div>
      </div>
