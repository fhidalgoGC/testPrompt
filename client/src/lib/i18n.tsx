    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "When you submit the form along with your proof of payment, you will receive an **automatic email** indicating that your payment is being validated. Once our team validates your payment, you will receive a second email with your assigned numbers from our %%official channels|#section-11%%. Afterwards, our **main communication channel is WhatsApp**, through which we will also contact you.",
        },
        {
