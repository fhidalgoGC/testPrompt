    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Una vez que todas las semillas han sido adquiridas, la seleccion de los numeros ganadores se realizara **1 dia despues**, de **SUPER GANA**, segun el horario establecido de acuerdo a cada premio. El resultado sera comunicado a todos los participantes por los canales oficiales.",
        },
        {
    ...
    terms: {
      ...
      sections: [
        ...
        },
        {
          ...
          body: "Once all seeds have been acquired, the winning numbers will be drawn **1 day later**, by **SUPER GANA**, according to the established schedule for each prize. The result will be communicated to all participants through the official channels.",
        },
        {
