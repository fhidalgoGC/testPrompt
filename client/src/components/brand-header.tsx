...
export function BrandHeader({ size = "default" }: { size?: "default" | "small" }) {
  ...
  return (
    <div className="flex items-center gap-2.5">
      <a href="https://www.instagram.com/maredorazio" target="_blank" rel="noopener noreferrer" className={`${imgSize} rounded-xl bg-white/10 flex items-center justify-center overflow-hidden`}>
