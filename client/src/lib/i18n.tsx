...
const translations = {
  es: {
    ...
    picker: {
      ...
      verifyModalTitle: "Verificacion de identidad",
      verifyModalSubtitle: "Necesitamos validar tu informacion antes de continuar.",
      verifyInfoDesc: "Ingresa tu telefono, correo e identificacion. Te enviaremos un codigo SMS para verificar tu numero.",
      smsExplanation: "Al continuar, te enviaremos un mensaje de texto con un codigo de 6 digitos para validar que el telefono es tuyo.",
  ...
  en: {
    ...
    picker: {
      ...
      verifyModalSubtitle: "We need to validate your information before proceeding.",
      verifyInfoDesc: "Enter your phone, email, and ID. We'll send you an SMS code to verify your number.",
      smsExplanation: "By continuing, we'll text you a 6-digit code to verify that the phone number is yours.",
