...
const translations = {
  es: {
    ...
    picker: {
      ...
      successDesc: "Tu compra ha sido registrada. Recibiras tus semillas en tu correo una vez verificado el pago.",
  ...
  en: {
    ...
    picker: {
      ...
      successDesc: "Your purchase has been registered. You will receive your seeds by email once payment is verified.",
