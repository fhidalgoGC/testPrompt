...
const translations = {
  es: {
    ...
    picker: {
      ...
      uploadProof: "Cargar comprobante",
      uploadProofDesc: "Sube una foto o PDF de tu comprobante de pago.",
      ...
      paymentWarningDesc: "Si no se confirma el pago dentro de 1 hora, tus semillas seran canceladas y podrian ser asignadas a otra persona.",
      closeBtn: "Cerrar",
  ...
  en: {
    ...
    picker: {
      ...
      uploadProofDesc: "Upload a photo or PDF of your payment proof.",
      ...
      paymentWarningDesc: "If payment is not confirmed within 1 hour, your seeds will be cancelled and may be assigned to someone else.",
      closeBtn: "Close",
