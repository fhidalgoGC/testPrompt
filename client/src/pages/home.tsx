  ...
  return (
    <div className="min-h-screen bg-background pb-24 text-foreground selection:bg-primary/30 selection:text-white">
      ...
      <div className="fixed bottom-6 right-6 z-50 flex flex-col items-end gap-3">
        ...
        >
          {chatOpen ? <div className="h-full w-full rounded-full bg-black flex items-center justify-center p-1.5"><img src="/logos/chat-bubbles.png" alt="Chat" className="h-full w-full rounded-full object-contain invert" /></div> : <div className="h-full w-full rounded-full bg-black flex items-center justify-center p-1.5"><img src="/logos/call-center.webp" alt="Soporte" className="h-full w-full rounded-full object-contain invert" /></div>}
        </button>
      </div>
