...
const staticRaffles = [
  {
    ...
    imageUrls: [
      new URL(
        "@assets/WhatsApp_Image_2026-03-15_at_14.31.59_1773672854861.jpeg",
        import.meta.url,
      ).href,
    ],
    totalTickets: 10000,
...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background pb-24 text-foreground selection:bg-primary/30 selection:text-white">
      ...
      <section className="pt-32 sm:pt-48 pb-4 sm:pb-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto relative">
        ...
        <h2 className="text-3xl sm:text-4xl font-bold text-black dark:text-black mb-8 text-center">
          Actívate con tus Semillas
        </h2>
        ...
        >
          <RaffleCard
            ...
            featured={true}
            badgeLabel={t.raffle.badgeLabels[0]}
          />
        </motion.div>
      </section>
      ...
      <section className="mt-8 sm:mt-12 px-4 max-w-4xl mx-auto text-center border-t border-border pt-4 sm:pt-8">
        ...
        <div className="flex justify-center gap-6 sm:gap-10">
          ...
          <div
            className="flex flex-col items-center group w-24"
            data-testid="lottery-Super Gana"
          >
          ...
          <div
            className="flex flex-col items-center group w-24"
            data-testid="lottery-Loteria del Tachira"
          >
            <div className="w-16 h-16 flex items-center justify-center overflow-hidden rounded-full mx-auto">
              <img
                src={tachiraImg}
                alt="Loteria del Tachira"
                className="w-full h-full object-cover"
              />
            </div>
      ...
      <section
        id="contacto"
        className="mt-4 sm:mt-8 px-4 max-w-4xl mx-auto border-t border-border pt-4 sm:pt-8 pb-8"
      >
        ...
        <div className="flex flex-col items-center justify-center gap-4">
          <a
            href="mailto:info@maredorazio.com"
            className="text-sm text-muted-foreground hover:text-primary transition-colors"
            data-testid="link-email"
          >
            info@maredorazio.com
          </a>
          <button
          ...
          >
            <div className="h-full w-full rounded-full bg-background flex items-center justify-center p-1.5">
              <img
                src={chatOpen ? chatBubblesImg : callCenterImg}
                alt="Soporte"
      ...
      <footer className="mt-4 px-4 py-6 border-t border-border text-center">
        ...
        <p className="text-xs text-muted-foreground mb-4">
          Plataforma de software diseñada y desarrollada por <a href="https://www.fremitech.com/" target="_blank" rel="noopener noreferrer" className="font-bold text-foreground hover:underline">Fremitech</a>
        </p>
